...
const SampleReview = () => {
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen transition-colors duration-200">
            <div className="max-w-8xl mx-auto px-4 py-8 lg:px-8">
                {/* Breadcrumb */}
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
                    <h1 className="text-2xl font-bold tracking-tight">Bulk Upload Sample &amp; Field Guide</h1>
                    <button className="mt-4 md:mt-0 bg-primary hover:bg-blue-700 text-white px-5 py-2.5 rounded-md flex items-center justify-center font-medium shadow-sm transition-all">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    <div className="lg:col-span-3 space-y-6">
                                ...
                                <table className="w-full text-left text-sm whitespace-nowrap">
                                    ...
                                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50 text-slate-600 dark:text-slate-300">
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                            ...
                                            <td class="px-4 py-4 font-mono text-xs">EL-WTC-FIT-04</td>
                                            ...
                                            <td class="px-4 py-4 text-center">105</td>
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/50 p-5 rounded-lg flex items-start space-x-4">
                            <div className="bg-blue-500/10 dark:bg-blue-400/10 p-2 rounded-full">
                                <VerifiedUserIcon className="text-blue-600 dark:text-blue-400" />
                            </div>
                            <div>
                                <h3 className="font-bold text-blue-900 dark:text-blue-300">Data Validation Pre-check</h3>
                                <p className="text-sm text-blue-800/80 dark:text-blue-400/80 mt-1 leading-relaxed">
