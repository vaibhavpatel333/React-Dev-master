            ...
            <header className=" top-0 z-30 bg-surface-light dark:bg-surface-dark border-b border-border-light dark:border-border-dark px-6 py-4">
                <div className="max-w-8xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="px-4 py-2 text-sm font-semibold border border-primary text-primary rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors uppercase tracking-wide">
                            Save Draft
                        </button>
                        <button className="px-4 py-2 text-sm font-semibold bg-primary text-white rounded shadow hover:bg-blue-700 transition-colors uppercase tracking-wide">
                            Publish Product
                        </button>
                    </div>
                </div>
                ...
                <section className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-lg p-6 mui-shadow">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm text-slate-500 dark:text-slate-400">This product has variants?</span>
                        </div>
                    </div>
                    <div className="bg-slate-50 dark:bg-slate-900/40 rounded-lg p-6 border border-border-light dark:border-border-dark mb-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="flex items-center gap-2 text-sm font-semibold text-primary mt-2">
