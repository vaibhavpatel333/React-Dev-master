            ...
            <div className="max-w-8xl mx-auto px-6 py-8">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        <nav aria-label="Breadcrumb" className="flex text-sm text-slate-500 dark:text-slate-400 mb-2">
                            <ol className="flex items-center space-x-2">
                                <li><a className="hover:text-primary" href="#">Store</a></li>
                                <li><ChevronRightIcon className="text-xs" /></li>
                                <li><a className="hover:text-primary" href="#">Products</a></li>
                                <li><ChevronRightIcon className="text-xs" /></li>
                                <li><a className="hover:text-primary" href="#">Bulk Upload</a></li>
                                <li><ChevronRightIcon className="text-xs" /></li>
                    ...
                    <div className="flex items-center gap-6">
                        <button className="text-slate-600 dark:text-slate-400 font-medium hover:text-slate-900 dark:hover:text-white transition-colors">Cancel</button>
                        <button className="bg-primary hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg font-semibold flex items-center gap-2 transition-all shadow-lg shadow-primary/20">
                            Start Import
